...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'smple', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.andong.eu.org', // 网站地址
  ...
  type_post: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_POST || '博客',
  type_page: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_PAGE || '单页',
  type_notice: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_NOTICE || '公告',
  type_menu: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_MENU || '菜单',
  type_sub_menu: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_SUB_MENU || '子菜单',
  title: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TITLE || '标题',
  status: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS || '状态',
  status_publish: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_PUBLISH || '已发布',
  status_invisible: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_INVISIBLE || '已隐藏',
