...
const BLOG = {
  ...
  NOTION_PROPERTY_NAME: {
    ...
    type: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE || '属性', // 页面属性,
    ...
    type_notice: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_NOTICE || '公告', // 当type文章类型与此值相同时，为公告Notice,
    type_menu: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_MENU || '菜单', // 当type文章类型与此值相同时，为菜单Menu,
    type_sub_menu: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_SUB_MENU || '子菜单', // 当type文章类型与此值相同时，为子菜单SubMenu,
    title: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TITLE || '标题' , // 文章标题,
    status: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS || '状态', // 文章状态,
    ...
    slug: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SLUG || '路径', // 文章路径,
    category: process.env.NEXT_PUBLIC_NOTION_PROPERTY_CATEGORY || '类型', // 文章类型,
